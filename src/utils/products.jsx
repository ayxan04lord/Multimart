...
export const SliderData = [
  {
      id: 1,
      title: "Headphones",
      desc: "Headphones are a pair of small loudspeaker drivers worn on or around the head over a user's ears. They are electroacoustic transducers, which convert an electrical signal to a corresponding sound.",
      cover: wireless01,
  },
  {
      id: 2,
      title: "Smartphone",
      desc: "A smartphone (often simply called a phone) is a mobile device that combines the functionality of a traditional mobile phone with advanced computing capabilities.",
      cover: phone08,
  },
  {
      id: 3,
      title: "Tablet",
      desc: "Discover the perfect blend of form and function with our latest tablet. Its ultra-slim profile and lightweight build make it effortlessly portable, while the sleek aluminum body ensures durability. Carry style and sophistication wherever you go.",
      cover: tablet,
  },
  {
      id: 4,
